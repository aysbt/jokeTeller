...
function toggleButton() {
    //When the button is active is make disable the button and vice verse. 
...
function jokeTeller(joke) {
    VoiceRSS.speech({
        key: '9dae1915b35241ab8ac1a98a5ccc61c7',
        src: joke,
        hl: 'en-us',
        r: 0,
        c: 'mp3',
...
async function getJokes() {
    let joke = '';
    const apiUrl = 'https://v2.jokeapi.dev/joke/Programming?blacklistFlags=nsfw,political,racist';
    try {
...
// When audio is finish makes button active again
